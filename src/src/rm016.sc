		...
		(switch (= state newState)
			(0
				(gSq4GlobalNarrator
					...
					returnVal: 0
					nMsgType: 2
					say: 1 self 2 64 1 160 67 318 25 global135 26 global129 27 1 30 68
				)
			)
			(1
			...
			(3
				...
				(if global83
					(tROGER
						...
						say: 3 0 2 64 30 15 67 175 25 global137 26 global129 27 0 30 68
					)
				)
				(rHand setCel: 1)
				(if (not (global2 script?))
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(10
				...
				(tSVGRUNT
					init: 0 0 spHead
					say: 1 self 2 64 95 15 67 120 25 global136 26 global129 27 0 30 68
				)
			)
			(11 (= seconds 2))
			(12
				(tROGER
					init: 0 0 rogMouth
					finalMouth: -1
					say: 1 self 2 64 45 15 67 160 25 global137 26 global129 27 0 30 68
				)
			)
			(13
				(tSVGRUNT
					init: 0 0 spHead
					say: 2 self 2 64 90 15 67 125 25 global136 26 global129 27 -1 30 68
				)
			)
			(14 (= seconds 3))
			(15
