...
(instance ripper2Script of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(13 (spGun setCycle: Beg self))
			(14 (= seconds 1))
			(15 (global2 newRoom: 20))
		)
	)
)
		...
		(switch (= state newState)
			...
			(1
				(gSq4GlobalNarrator
					...
					returnVal: 0
					nMsgType: 3
					say: 1 0 2 64 5 160 67 310 25 global136 26 global129 27 1 30 310
				)
				(= cycles 2)
			)
			(2
			...
			(6 (puker setCycle: Beg self))
			(7
				(puker setCycle: CT 3 1 self)
			)
			(8 (puker setCycle: Beg self))
			(9
				(puker setCycle: CT 5 1 self)
			)
			(10 (puker setCycle: Beg self))
			(11
