...
(class GameControls of IconBar
	...
	(method (dispatchEvent pEvent &tmp gSq4WinEraseOnly temp1 temp2 [temp3 50] pEventType pEventMessage)
				...
				((== pEventType evHELP)
					(if
						(and
							...
							((= temp1 (self firstTrue: #onMe pEvent)) helpVerb?)
						)
						(= temp2 (GetPort))
						(if (gSq4Win respondsTo: #eraseOnly)
